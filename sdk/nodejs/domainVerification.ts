...
/**
 * A Resend domain verification trigger that waits for DNS verification to complete.
 */
export class DomainVerification extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'resend:index:DomainVerification';
    ...
    /**
     * The Resend domain ID to verify.
     */
