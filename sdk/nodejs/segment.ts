...
/**
 * A Resend segment for contact segmentation. Segments allow you to group contacts based on filter criteria for targeted broadcasts. Note: Segments are immutable after creation - any changes require replacement.
 */
export class Segment extends pulumi.CustomResource {
    ...
    /**
     * Optional filter criteria for the segment. This is an opaque object as the API doesn't fully document the schema. This field is immutable after creation.
     */
    declare public readonly filter: pulumi.Output<{[key: string]: any} | undefined>;
    /**
     * The name of the segment. This field is immutable after creation.
     */
